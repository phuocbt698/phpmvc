                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody id="data">
                                    <?php foreach($cateogry as $key=>$item): ?>
                                    <tr>
                                        <td>
                                            <?=$key+1?>
                                        </td>
                                        ...
                                        <td>
                                            <a href="<?=_URL_ . '/admin/category/update/' . $item['id']?>"
...
function deleteItem(id) {
    ...
    if (check) {
        $.ajax({
            url: "<?=_URL_ . '/admin/category/delete/'?>" + id,
            method: 'POST',
            success: function(data) {
                ...
                $.each(data, function(key, item) {
                    table.append(
                        ...
                        "<td>" + item['name'] + "</td>" +
                        "<td>" + 
                        "<a href='<?=_URL_ . '/admin/category/update/'?>" + item['id'] + "' style='margin-right: 25px;'>" +
                         "<i class='fas fa-edit'></i>"+
                        "</a>"+
