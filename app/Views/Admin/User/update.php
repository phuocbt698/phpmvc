                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role" id="role">
                                        ...
                                        <option <?=($item['id'] == $user['role_id']) ? 'selected' : ''?> value="<?=$item['id']?>"><?=strtoupper($item['name'])?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="imageOld" style="margin-top: 2%;">
                                            <label for="">Ảnh cũ</label>
                                            <img src="<?=_URL_ . '/public/image/admin/' . $user['image']?>" alt="" width="100%">
                                    </div>
